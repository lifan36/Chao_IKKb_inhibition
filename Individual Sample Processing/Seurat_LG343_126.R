...
LG343_126.counts <- Read10X(data.dir = "/Users/lifan/Box Sync/Li_Fan_Research/10x/ChaoWang_IKKb/LG343_126/filtered_feature_bc_matrix")
LG343_126 <- CreateSeuratObject(counts = LG343_126.counts, project = "LG343_126", min.cells = 3, min.features = 200)
LG343_126[["Condition"]] = c('IKKbKO; Ctrl; PS19/+')
...
all <- doubletFinder_v3(all, PCs = 1:10, pN = 0.25, pK = 0.005, nExp = nExp_poi.adj, reuse.pANN = "pANN_0.25_0.005_804", sct = FALSE)
...
rm(all)
singlets<-saveRDS(singlets,"LG343_126_singlets.rds")
...
write.csv(singlets.markers,"LG343_126_cluster_markers_singlets.csv")

singlets<-saveRDS(singlets,"LG343_126_singlets_PCA.rds")
