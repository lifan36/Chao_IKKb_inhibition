...
LG343_108.counts <- Read10X(data.dir = "/Users/lifan/Box Sync/Li_Fan_Research/10x/ChaoWang_IKKb/LG343_108/filtered_feature_bc_matrix")
...
rm(all)
singlets<-saveRDS(singlets,"LG343_108_singlets.rds")
...
write.csv(singlets.markers,"LG343_108_cluster_markers_singlets.csv")

singlets<-saveRDS(singlets,"LG343_108_singlets_PCA.rds")
